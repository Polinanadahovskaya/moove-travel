  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isMobile.value || isTablet.value) {
        _push(`<div class="${ssrRenderClass([{ "color-black": unref(route).path === "/about" || unref(route).path.startsWith("/article") || unref(route).path === "/Travel-gids", "text-white": unref(route).path === "/blog" }, "giv-lid"])}" data-v-31f657d7> Нажимая «Оставить заявку» вы даёте согласие <br data-v-31f657d7> на `);
      ...
      if (!isMobile.value && !isTablet.value) {
        _push(`<div class="${ssrRenderClass([{ "color-black": unref(route).path === "/about" || unref(route).path === "/blog" }, "giv-lid"])}" data-v-31f657d7>Нажимая «Оставить заявку» <br data-v-31f657d7> вы даёте согласие на `);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/loyarInformation",
...
//# sourceMappingURL=popupApplication-DEi7na23.js.map
