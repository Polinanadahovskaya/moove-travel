...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "popup-comp" }, _attrs))} data-v-667d8136><div class="close-btn" data-v-667d8136>×</div><div data-v-667d8136><div class="popup-width" data-v-667d8136><div class="popup-inputs" data-v-667d8136><div class="pop-in" data-v-667d8136><input class="${ssrRenderClass([{ "error": nameError.value }, "popup-input"])}" type="text" id="userName" name="userName" placeholder=" "${ssrRenderAttr("value", name.value)} data-v-667d8136><label class="popup-label" for="userName" data-v-667d8136>Имя</label>`);
      if (nameError.value) {
...
//# sourceMappingURL=popupBeforePay-D14IRMdU.js.map
