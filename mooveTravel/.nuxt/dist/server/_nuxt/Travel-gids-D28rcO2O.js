...
import bestVariant from "./bestVariant-B5oENuzP.js";
import tubCountry from "./tubCountry-Cpjc6j-L.js";
import PopupTravelGid from "./popupTravelGid-IggH4fpp.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-6b8d18bf><div class="travel-body container" data-v-6b8d18bf><div class="travel-gid" data-v-6b8d18bf><h1 class="travel-tittle" data-v-6b8d18bf>TRAVEL-ГИДЫ</h1><div class="travel-border" data-v-6b8d18bf></div></div><div class="travel-text" data-v-6b8d18bf>${ssrInterpolate((_a = unref(guidePage)) == null ? void 0 : _a.description)}</div><h2 class="travel-tittle travel-country" data-v-6b8d18bf>Лучшие предложения</h2><div class="travel-grid" data-v-6b8d18bf><!--[-->`);
      ssrRenderList((_b = unref(guidePage)) == null ? void 0 : _b.bestGuides, (arr) => {
        _push(`<div data-v-6b8d18bf>`);
        _push(ssrRenderComponent(bestVariant, {
          info: arr == null ? void 0 : arr.travel_guide
        }, null, _parent));
        _push(`</div>`);
      });
      _push(`<!--]--></div><h2 class="travel-country" data-v-6b8d18bf>Страны</h2><div class="travel-grid gid-trav" data-v-6b8d18bf><!--[-->`);
...
const TravelGids = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6b8d18bf"]]);
export {
  TravelGids as default
};
//# sourceMappingURL=Travel-gids-D28rcO2O.js.map
