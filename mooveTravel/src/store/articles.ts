...
export const useArticlesStore = defineStore('articles', {
  ...
  actions: {
    ...
    async fetchArticleByLink(link: string) {
      ...
      this.error = null
      try {
        const response = await axios.get(`http://localhost:1337/api/articles?filters[link][$eq]=${encodeURIComponent(link)}&populate[article_tags]=*&populate[country]=*&populate[articlePhotos][populate]=*&populate[user][populate]=*`,
          {
            headers: {
              Authorization: 'Bearer ',
            },
